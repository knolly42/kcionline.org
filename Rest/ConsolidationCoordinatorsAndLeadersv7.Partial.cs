...
namespace org.kcionline.bricksandmortarstudio.Rest
{
    ...
    public class ConsolidationCoordinatorsAndLeadersController : Rock.Rest.ApiController<Person>
    {
        public ConsolidationCoordinatorsAndLeadersController() : base(new PersonService(new RockContext())) { }

        /// <summary>
        /// Returns results to the Person Picker for Rock v7
        /// </summary>
        ...
        [HttpGet]
        [System.Web.Http.Route("api/com_bricksandmortarstudio/ConsolidatonCoordinatorsAndLeaders")]
        public IQueryable<PersonSearchResult> Search(string name, bool includeHtml, bool includeDetails, bool includeBusinesses = false, bool includeDeceased = false)
        {
            ...
            // Get the line leaders and coordinators for the current user
            ...
            // Cross match the allowed people and the search results
