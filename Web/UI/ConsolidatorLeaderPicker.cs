...
{
    public class ConsolidatorLeaderPicker : CompositeControl, IRockControl
    {
        ...
        public int? PersonId
        {
            get
            {
                ...
                {
                    _hfPersonId.Value = None.IdValue;
                }

                if ( _hfPersonId.Value.Equals( None.IdValue ) )
                {
                    return null;
                }
        ...
        public string PersonName
        {
            get
            {
                ...
                {
                    _hfPersonName.Value = None.TextHtml;
                }
        ...
        {
            string restUrl = ResolveUrl( "~/api/com_bricksandmortarstudio/ConsolidatonCoordinatorsAndLeaders" );
        ...
        public override void RenderControl( HtmlTextWriter writer )
        {
            ...
            if ( Visible )
            {
                ControlHelper.RenderControl( this, writer );
            }
        }
        ...
        public void RenderBaseControl( HtmlTextWriter writer )
        {
            if ( Enabled )
            {
                ...
                writer.AddAttribute( "class", string.Format( "picker picker-select picker-person {0}", CssClass ) );
...
";
                writer.Write(pickerLabelHtmlFormat, ClientID, PersonName);
...
";
                ...
                writer.Write( pickMenuHtmlFormatStart, ClientID );
...
";
                ...
                writer.Write(pickMenuHtmlFormatEnd, ClientID);
            ...
            else
            {
                ...
                linkButton.Text = string.Format( "<i class='{1}'></i><span>{0}</span>", PersonName, "fa fa-user" );
